...
class ActivityViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    func updateUI(){
        ...
        // 4
        let paceObj = Pace(seconds: sec, minutes: sec / 60, distance: Double(runs[e].distance)!)
...
class ActivityTableViewCell: UITableViewCell {
    ...
    func updateUI(n:Int){
        ...
        self.dateLabel.text = runs[n].date
        self.distanceLabel.text = runs[n].distance
        self.durationLabel.text = String(runs[n].duration)
