...
//-> The room is CLEAN!
 ...
 ## ex. 3
 ### Promise.all
* Returns a P that either fulfills when all of the P in the iterable argument have fulfilled or rejects as soon as one of the P in the iterable argument rejects
### Promise.race
* Returns a P that fulfills or rejects as soon as one of the P in the iterable fulfills or rejects, with the value or reason from that P
```javascript
