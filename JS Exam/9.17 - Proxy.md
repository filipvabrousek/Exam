...
* 1) trap target - object, that will recive property
* 2) key - the property key (String / Symbol) to write to
* 3) value - value being written to property
* 4) receiver - the object on which the operation took place
